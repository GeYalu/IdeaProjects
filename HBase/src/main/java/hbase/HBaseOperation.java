...
public class HBaseOperation {
    ...
    public static void addDataWithTS(String rowKey, String tableName,String familycolumn, String[] column, String[] value,long timestamp) {
        initLog();
    ...
    public static void createTable(String tableName, String[] family) {
        ...
        try {
            ...
            for (int i = 0; i < family.length; i++) {
                ...
                hColumnDescriptor.setMaxVersions(300);
