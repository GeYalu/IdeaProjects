...
public class LinkedListSummary {
    ...
    static Node addLists(Node l1, Node l2) {
        ...
        list1.add(l1.value);
        while(l1.next!=null){
            list1.add(l1.next.value);
            l1=l1.next;
        }
        list2.add(l2.value);
        while(l2.next!=null){
            list2.add(l2.next.value);
            l2=l2.next;
        }

        int len1 = list1.size();
        int len2 = list2.size();
        l3.value =  Integer.valueOf(list1.get(0).toString())+Integer.valueOf(list2.get(0).toString());
        Node l4 = l3;
        if(len1>=len2){
            for (int i=1;i<len2;i++){
                l4.next = new Node(Integer.valueOf(list1.get(i).toString())+Integer.valueOf(list2.get(i).toString()));
                l4=l4.next;
            }
            for (int i=len2;i<len1;i++){
                l4.next = new Node(Integer.valueOf(list1.get(i).toString()));
                l4=l4.next;
            }
            l4=null;
        }else{
            ...
            for (int i=len1;i<len2;i++){
                l4.next = new Node(Integer.valueOf(list2.get(i).toString()));
                l4=l4.next;
            }
            l4=null;
